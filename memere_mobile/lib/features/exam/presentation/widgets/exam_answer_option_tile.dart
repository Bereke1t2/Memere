...
/// Live-attempt answer tile. Renders selection state only — never correct or
/// wrong styling, which is result-only.
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(answer.text, style: AppTextStyles.bodyMedium),
                ),
              ],
            ),
          ),
